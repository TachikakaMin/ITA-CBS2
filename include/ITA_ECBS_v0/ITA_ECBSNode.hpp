...
public:
    ...
    bool update_cost_matrix(ITA_ECBS* pInstance, int agent_id, Constraints& new_constraint);
    bool get_next_assignment(int agent_id, double w, vector<bool>& changed_agent);
    int get_LB();
    int get_cost();
