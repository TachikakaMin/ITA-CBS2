# Documentation: `ITA-CBS2/python/generate_data_for_exp1.py`

- Source File: `ITA-CBS2/python/generate_data_for_exp1.py`
- Language: `Python`
- Generated: `2026-03-05`

## Purpose
- Generates experiment-1 datasets with configurable map/goal distributions.

## Top-Level Classes

- `HashPoint` methods: `__init__`, `__hash__`, `tolist`
